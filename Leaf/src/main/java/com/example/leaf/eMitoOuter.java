...
//manages the outer mitochondrial membrane scene
public class eMitoOuter {
    ...
    private void dayNNite(){
        ...
        if(Manager.isDay()) {
            //set the pictures
            Image outer = new Image("/imgs/outer.png");
            outerPic.setImage(outer);

            Image sun = new Image("/imgs/sun.png");
            time.setImage(sun);

            infobar.setText(Infobars.Outerday.getInfo());
            goal.setText(Goals.Outerday.getGoal());
        }
        else{
            //set the pictures
            Image outer = new Image("/imgs/outer.png");
            ...
            infobar.setText(Infobars.Outernight.getInfo());
            goal.setText(Goals.Outernight.getGoal());
        }
    }
}
