...
//manages the mitochondrial matrix scene
public class eMitoMatrix {
    ...
    private void dayNNite(){
        ...
        if(Manager.isDay()) {
            //set the pictures
            Image matrix = new Image("/imgs/matrix.png");
            matrixPic.setImage(matrix);

            Image sun = new Image("/imgs/sun.png");
            time.setImage(sun);

            infobar.setText(Infobars.Matrixday.getInfo());
            goal.setText(Goals.Matrixday.getGoal());
        }
        else{
            //set the pictures
            Image matrix = new Image("/imgs/matrix.png");
            ...
            infobar.setText(Infobars.Matrixnight.getInfo());
            goal.setText(Goals.Matrixnight.getGoal());
        }
    }
}
