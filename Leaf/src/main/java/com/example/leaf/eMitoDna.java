...
//manages the mitochondrial dna scene
public class eMitoDna {
    ...
    private void dayNNite(){
        ...
        if(Manager.isDay()) {
            //set the pictures
            Image dna = new Image("/imgs/dna.png");
            dnaPic.setImage(dna);

            Image sun = new Image("/imgs/sun.png");
            time.setImage(sun);

            infobar.setText(Infobars.DNAday.getInfo());
            goal.setText(Goals.DNAday.getGoal());
        }
        else{
            //set the pictures
            Image dna = new Image("/imgs/dna.png");
            ...
            infobar.setText(Infobars.DNAnight.getInfo());
            goal.setText(Goals.DNAnight.getGoal());
        }
    }
}
