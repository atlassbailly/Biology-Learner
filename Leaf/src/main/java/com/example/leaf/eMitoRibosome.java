...
//manages the ribosome scene
public class eMitoRibosome {
    ...
    private void dayNNite(){
        ...
        if(Manager.isDay()) {
            //set the pictures
            Image ribosome = new Image("/imgs/ribosome.png");
            ribosomePic.setImage(ribosome);

            Image sun = new Image("/imgs/sun.png");
            time.setImage(sun);

            infobar.setText(Infobars.Ribosomeday.getInfo());
            goal.setText(Goals.Ribosomeday.getGoal());
        }
        else{
            //set the pictures
            Image ribosome = new Image("/imgs/ribosome.png");
            ...
            infobar.setText(Infobars.Ribosomenight.getInfo());
            goal.setText(Goals.Ribosomenight.getGoal());
        }
    }
}
