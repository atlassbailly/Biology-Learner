...
public class cVein {
    ...
    private void dayNNite(){
        ...
        if(Manager.isDay()) {
            //set the pictures
            Image image = new Image("/imgs/veinday.png");
            veinPic.setImage(image);

            Image sun = new Image("/imgs/sun.png");
            time.setImage(sun);

            infobar.setText(Infobars.Veinday.getInfo());
            goal.setText(Goals.Veinday.getGoal());
        }
        else{
            //set the pictures
            Image image = new Image("/imgs/veinnight.png");
            veinPic.setImage(image);

            Image moon = new Image("/imgs/moon.png");
            time.setImage(moon);

            infobar.setText(Infobars.Veinnight.getInfo());
            goal.setText(Goals.Veinnight.getGoal());
        }
    }
}
